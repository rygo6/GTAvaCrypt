...
First, select the FBX file of your Avatar in the Project Pane in the Unity Editor. View the FBX files "Import Settings" in the Inspector Pane, in here set "Normals" to "Import". This may not always be necessary, but I found it was for my avatars. If your avatar mesh is a .Asset rather than a .FBX, this may not work, I have not tested it heavily with .Asset mesh sources.
